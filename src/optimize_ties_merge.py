...
def optimize_ties_params(
    ...
    output_dir="./experiments/optuna_ties",
    study_name = "ties",
    n_trials=50,
    device="cuda"
):
    ...
    save_dir = "./experiments/results/optuna_ties"
